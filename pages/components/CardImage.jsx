...
function CardImage({ src, isReverse = true }) {
    return (
        <>
            <div className="sm:py-[106px] sm:pt-[106] py-[48px] sm:px-[268px] px-[30px] before:bg-[url('/video-image-1.png')] before:bg-center before:absolute before:inset-0 before:bg-cover before:content-[''] relative before:opacity-5">
